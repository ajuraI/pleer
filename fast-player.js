    ...
    class RPlayer extends HTMLElement {
        constructor() {
            ...
            if (this.hasAttribute('src')) {
                ...
                let uptop;
                let lowtop;
                let picture = 'https://img.icons8.com/cute-clipart/64/000000/music-library.png';
                let type;
                let premiumGradient = 'background: linear-gradient(to top, rgba(255, 255, 255, 1), rgba(255, 255, 255, 0.4));';
                let content = '';
                let bufferInfo = '';
                let social = '';
                let inst;
                ...
                if (!this.hasAttribute('menu') || this.getAttribute('menu') === 'false') menu = 'disablemenu';
                if (this.hasAttribute('idNum')) idNum = this.getAttribute('idNum');
				if (this.hasAttribute('downloadbut')) downloadbut = this.getAttribute('downloadbut');
                if (this.hasAttribute('author')) author = this.getAttribute('author');
                if (this.hasAttribute('uptop')) uptop = this.getAttribute('uptop');
                if (this.hasAttribute('lowtop')) lowtop = this.getAttribute('lowtop');
                if (this.hasAttribute('picture')) picture = this.getAttribute('picture');
                if (this.hasAttribute('type')) type = this.getAttribute('type');
                if (type && type === 'premium') {
                    premiumGradient = 'background: linear-gradient(to top, rgba(255, 230, 215, 1), rgba(255, 230, 215, 0.4));'
                }
                if (this.hasAttribute('content')) content = this.getAttribute('content');
                if (content) {
                    bufferInfo = content;
                ...
                if (this.hasAttribute('soundcloud')) {
                    soundcloud = this.getAttribute('soundcloud');
                ...
                if (this.hasAttribute('yandex')) {
                    yandex = this.getAttribute('yandex');
                ...
                if (this.hasAttribute('itunes')) {
                    itunes = this.getAttribute('itunes');
